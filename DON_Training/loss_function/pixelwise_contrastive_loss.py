...
class PixelwiseContrastiveLoss(object):
    ...
    def non_match_descriptor_loss(image_a_pred, image_b_pred, non_matches_a, non_matches_b, M=0.5, invert=False):
        ...
        :rtype:
        """
        #print (non_matches_a.shape,non_matches_b.shape)
        #print (non_matches_a.device, non_matches_b.device)
        ...
        #print(non_matches_a_descriptors.shape, non_matches_b_descriptors.shape)

        #print (torch.min(non_matches_a),torch.max(non_matches_a))
        #print(torch.min(non_matches_b), torch.max(non_matches_b))
        ...
        # print (non_matches_a.cpu().data.numpy(),non_matches_b.cpu().data.numpy())
