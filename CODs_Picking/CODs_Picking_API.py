...
class CODs_Picking_API():
    def __init__(self):
        
        setting = "RGBD"

        #pickingPretrainedModelPath = "../CODs_Picking/trained_models/Picking_ITRI_ResNet4_SRCODs/Picking_100" # no normalize
        pickingPretrainedModelPath =  "../CODs_Picking/trained_models/Server_GraspNet_Picking_tutorial/Picking_50"
        ...
        print ("CODse load ",pickingPretrainedModelPath)
