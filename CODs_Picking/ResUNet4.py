...
from CODs_Training.model import Resnet34_8s
import torch

from collections import namedtuple, OrderedDict
from CODs_Picking.UNetPicking import DoubleConv, Down, Up
...
class RUNet(nn.Module):
    ...
    def __init__(self, modeObsevation, n_classes, bilinear=True,
                  CODs_pretrained="CODs_GraspNet_O2O_full_rotation_index_plus_ITRI_insideNonMatch_rd_08_RGBD_Resnet/CODs_120000"):
                  #pretrained="CODsD_ResUnet_8_best_D_Resnet/CODs_80000"):
        #super().__init__()
        super(RUNet, self).__init__()
        setting = modeObsevation
        self.CODs = DensObjectNet(setting=setting, pretrained=CODs_pretrained)
...
#print(depth.shape)
        ...
        (l1, l2, l3, l4, l5,l6) = self.CODs.getBatchLayer(rgb,depth)
...
from CODs_Training.DataGenerator_O2O import convertToHeatmap

# test model
if __name__ == "__main__":
    pathScene = "../../dataCODs/GraspNet_orig/Object29/002"
    idx = 1
    # batch_size = 8
