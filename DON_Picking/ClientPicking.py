        ...
        for step2M in range(1):  # for each 4M timestep. Total 48M
            for epi in tqdm(range(nEpisode)):
                ...
                if (not opt.evaluation):
                    ...
                    tensorboard.add_scalar("DieReason/DONE_FINISH", errorCode[StatusCode.DONE_FINISH] / nTrajectory, totalTimeStep)
                    ...
                    tensorboard.add_scalar("DieReason/DONE_EXCEEDED_MAX_ACTION",errorCode[StatusCode.DONE_EXCEEDED_MAX_ACTION] / nTrajectory, totalTimeStep)
