...
import warnings
import logging
from CODs_Training.model import Resnet34_8s,Resnet34_8s_orig,Resnet34_8s_dual
#from CODs_Training.pspnet import PSPNet
#from CODs_Training.UNET_New import FullUNet
#from CODs_Training.UnetCODs import UnetCODs
...
class DenseCorrespondenceNetwork(nn.Module):
    ...
    def __init__(self, fcn, descriptor_dimension, image_width=512,
        ...
        # defaults to no image normalization, assume it is CODse by dataset loader instead
    ...
    def get_fcn(config,setting):
        ...
        #   fcn = UnetCODs(config["inputChannel"][setting], config["nDimesion"])#  FullUNet(config["inputChannel"][setting], config["nDimesion"])
