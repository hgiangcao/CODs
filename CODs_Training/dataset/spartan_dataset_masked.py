...
import correspondence_tools.correspondence_augmentation as correspondence_augmentation

from dataset.scene_structure import SceneStructure
...
class SpartanDataset(DenseCorrespondenceDataset):
    ...
    def __init__(self, debug=False, mode="train", config=None, config_expanded=None, verbose=False):
        ...
        :param config_expanded: When a config is read, it is parsed into an expanded form
            ...
            for how this is CODse.  We want to save this expanded config to disk as it contains
    ...
    def get_random_scene_name(self):
        ...
        if len(types) == 0:
            raise ValueError("I CODs't think you have any scenes?")
